...
@Repository
public class CreditorForSqlDaoImpl implements ICreditorForSqlDAO {

	@PersistenceContext
	private EntityManager em; // 相当于hibernate中的session,需要注入
	...
	public List<CreditorModel> findCreditorByCondition(Map<String, Object> map) {
		...
		sql += " and b.rn >" + startIndex + " and b.rn<=" + (startIndex + currentNum)
				+ " and a.d_id=b.d_id order by a.d_id";
